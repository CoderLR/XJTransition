...
class XJNavigationViewController: UINavigationController, UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if #available(iOS 15.0, *) {
            ...
            self.navigationBar.titleTextAttributes = [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 18),NSAttributedString.Key.foregroundColor: UIColor.black]
